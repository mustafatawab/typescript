...
class A {
    ...
    constructor(theName: string, age:number) { 
        this.name = theName; 
        console.log(theName , " age is" , age);
    }
}
class B extends A {
    constructor(theName2 : string = "B class contuctor" , age2 : number = 18){
        super(" A Class Constructor" , 14)
        console.log(theName2 , "Age is " , age2);
...
let c: B = new B("" , 15);      // This is not working as child class must use parents constructor
